...
int cardEffectMinion(int choice1, int choice2, struct gameState *state, int handPos, int currentPlayer) {
	...
	else if (choice2)		//discard hand, redraw 4, other players with 5+ cards discard hand and draw 4
	{
		...
		//draw 4
		for (int i = 0; i < 4; i++)// initializing i here might not be the best (make it more global for the next for loop?)
	    {
...
int cardEffect(int card, int choice1, int choice2, int choice3, struct gameState *state, int handPos, int *bonus)
{
  ...
  switch( card ) 
    ...
    case ambassador:
    	return cardEffectAmbassador(int choice1, int choice2, struct gameState *state, int handPos, int currentPlayer);
